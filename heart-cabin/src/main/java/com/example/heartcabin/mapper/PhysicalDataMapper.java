...
public interface PhysicalDataMapper {
    ...
    @Insert("insert into physical_data(user_id, heart_rate, sleep_hours, steps, record_date, data_source, create_time) " +
            "values(#{userId}, #{heartRate}, #{sleepHours}, #{steps}, #{recordDate}, #{dataSource}, now())")
